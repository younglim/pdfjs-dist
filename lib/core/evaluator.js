...
exports.TextState = exports.StateManager = exports.PartialEvaluator = exports.EvaluatorPreprocessor = void 0;
...
var _bounding_boxes = require("./bounding_boxes");
...
class PartialEvaluator {
      ...
      switch (key) {
        ...
        case "Font":
          ...
          promise = promise.then(() => {
            return this.handleSetFont(resources, null, value[0], operatorList, task, stateManager.state).then(function (translated) {
  ...
  getOperatorList({
    ...
    var boundingBoxCalculator = new _bounding_boxes.BoundingBoxesCalculator(!(intent & _util.RenderingIntentFlag.OPLIST));
    var self = this;
    var xref = this.xref;
